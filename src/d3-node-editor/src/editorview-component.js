...
export class EditorView {
    ...
    constructor(editor: NodeEditor, container: HTMLElement, menu: ?ContextMenu) {
        ...
        this.appState = new AppState(this.editor,this.container,this.contextMenu);
        this.appState.editorView = this;
    ...
    connectionProducer(x1, y1, x2, y2) {
        ...
        var p1 = [x1, y1];
        var p2 = [x1, y1 + offsetY];
        var p3 = [x2, y2 - offsetY];
        var p4 = [x2, y2];
    ...
    update() {
        ...
        // this.appState.nodes = this.editor.nodes;
        // this.appState.paths = this.editor.paths;
        console.log((this.editor.nodes[1]||{}).position);
        this.appState.initNodes(this.editor.nodes);
        // this.$cd.scan();
    }
